...
<script>
    ...
    export default {
        ...
        methods: {
            ajaxlist(){
                var _this = this;
                axios.get(plus.path + '/api/learn/list', {
                    params: {
                        page: _this.page,
                        limit: _this.limit
                    }
            ...
            deletes(index){
                ...
                this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
                    ...
                    axios.post(plus.path + '/api/learn/delete', {
            ...
            check(index){
                this.$router.push({path: '/home/learninfo', query: {id: this.tableData[index].id}})
            },
            ...
            add(){
                this.$router.push({path: '/home/learninfo'})
            },
        }
    }
</script>
